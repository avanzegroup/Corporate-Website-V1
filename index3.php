...
<div class="slide-container clearfix" >
	...
	<div class="slider clearfix">
		...
		<div class="sld sldimg" style="display: inline-block;">
			...
			<img class="lazy zimg" src="" data-original="img/img/7.jpg" alt="Business Process Outsourcing | Avanze Group Delaware USA">
		</div>		
		...
		<div class="sld sldimg">
			...
			<img class="lazy zimg" src="" data-original="img/img/2.jpg" alt="Mortgage Services">
		</div>
		...
		<div class="sld sldimg">
			...
			<img class="lazy zimg" src="" data-original="img/img/test.jpg" alt="Healthcare Services">
		</div>
		...
		<div class="sld sldimg">
			...
			<img class="lazy zimg" src="" data-original="img/img/data.jpg" alt="Data management Services">
		</div>
		...
		<div class="sld sldimg">
			...
			<img class="lazy zimg" src="" data-original="img/img/learning.jpg" alt="Learning Services">
		</div>
			...
			<img class="lazy zimg" src="" data-original="img/img/6-1.jpg" alt="Technology Services">
		</div>
			...
			<div class="container">
				...
				<div class="sep"></div>
					...
					<!-- sec-services Ends -->
									...
									<!-- twitter Starts -->
			<div class="twitter clearfix" style="margin-top: 0px;">
