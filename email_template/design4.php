        ...
        <tr style="font-family:calibri; color: #ffffff;">
          ...
          <td style="padding:10px 30px; margin:0; background: #F36565; color: #ffffff;">
            <table style="width:100%;padding:10px;text-align:center;">
              <tr>
                <td colspan="2" style="font-size:1.8em; font-family:calibri; color: #ffffff;">ADVANTAGE AVANZE</td>
              </tr>

              <tr>
                <td style="width:80px;font-size: 2.5em; color: #ffffff;">1</td>
                <td style="text-align:left; color: #ffffff; font-size: 1.2em;">
                  <p>Data Management</p>
                </td>
              </tr>

              <tr>
                <td style="width:80px;font-size: 2.5em; color: #ffffff;">2</td>
                <td style="text-align:left; color: #ffffff; font-size: 1.2em;">
              ...
              <tr>
                <td style="width:80px;font-size: 2.5em; color: #ffffff;">3</td>
                <td style="text-align:left; color: #ffffff; font-size: 1.2em;">
                  <p>Revised Parameters</p>
                </td>
              </tr>

              <tr>
                <td style="width:80px;font-size:2.5em; color: #ffffff;">4</td>
                <td style="text-align:left; color: #ffffff; font-size: 1.2em;">
              ...
              <tr>
                <td style="width:80px;font-size: 2.5em; color: #ffffff;">5</td>
                <td style="text-align:left; color: #ffffff; font-size: 1.2em;">
              ...
              <tr>
                <td style="width:80px;font-size: 2.5em; color: #ffffff;">6</td>
                <td style="text-align:left; color: #ffffff; font-size: 1.2em;">
                  <p>Experienced, accurate and fast</p>
                </td>
              </tr>

                            <tr>
                <td style="width:80px;font-size: 2.5em; color: #ffffff;">7</td>
                <td style="text-align:left; color: #ffffff; font-size: 1.2em;">
                  <p>Quicker Turn Times</p>
                </td>
              </tr>

                            <tr>
                <td style="width:80px;font-size: 2.5em; color: #ffffff;">8</td>
                <td style="text-align:left; color: #ffffff; font-size: 1.2em;">
                  <p>Quality and Compliance - Guaranteed</p>
                </td>
              </tr>
