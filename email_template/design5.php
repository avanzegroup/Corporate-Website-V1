        ...
        <td align="center" valign="top">
            ...
            border-bottom: 5px solid #ffffff;">
              ...
              <tbody>
                ...
                <tr><td align="center" style="border-bottom: #cccccc 1px solid;"><img src="http://www.avanzegroup.com/img/email/banner4.jpg" width="640"/></td></tr>
          ...
          <td style=" margin:0; color: #ffffff;">
            <table style="width:100%; text-align:center;" border="0" cellspacing="0">
              ...
              <td style="width:50px; font-size: 8em; color: #333333;"></td>
                <td style="text-align: left;"><span>We have serviced the real estate community for over 160 years...with history dating back to 1847.</span></td>
              </tr>
              ...
              <tr>
              <td style="width:50px; font-size: 8em; color: #333333;"></td>
                <td style="text-align: left;"><span>We are part of Fidelity National Financial, Inc. the largest title insurance group in the world.</span></td>
              </tr>
              ...
              <tr><td height="8"></td></tr>
                ...
                <td style="width:80px;font-size: 2.5em; color: #333333;"><img src="http://avanzegroup.com/img/email/tick.png" width="30"/></td>
                <td style="text-align:left; color: #333333; font-size: 1.2em;">
                  <p style="font-weight: 600;">Security</p>
                </td>
              </tr>

              <tr>
              <td style="width:50px; font-size: 8em; color: #333333;"></td>
                <td style="text-align: left;"><span>Through FNF, we offer over $1.8 billion in title claims reserves, giving our clients the ultimate protection</span></td>
              </tr>
              ...
              <tr><td height="8"></td></tr>
                ...
                <td style="width:80px;font-size: 2.5em; color: #333333;"><img src="http://avanzegroup.com/img/email/tick.png" width="30"/></td>
                <td style="text-align:left; color: #333333; font-size: 1.2em;">
                  <p style="font-weight: 600;">Financial Ratings</p>
                </td>
              </tr>

              <tr>
              <td style="width:50px; font-size: 8em; color: #333333;"></td>
                <td style="text-align: left;"><span>We are regularly reviewed and receive A Ratings from the nations major rating agencies.</span></td>
              </tr>
              ...
              <tr>
              <td style="width:50px; font-size: 8em; color: #333333;"></td>
                <td style="text-align: left;"><span>With a nationwide network of offices and our internation division, you transaction boundaries are almost unlimited.</span></td>
              </tr>
