...
<head>
  ...
  @import url(https://fonts.googleapis.com/css?family=Ubuntu:300,300i,400,400i,500,500i,700,700);  
  @import url(https://fonts.googleapis.com/css?family=Roboto+Condensed);
  </style>
  <link href="http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800" rel="stylesheet" type="text/css">
   <link href="https://fonts.googleapis.com/css?family=Ubuntu:300,300i,400,400i,500,500i,700,700" rel="stylesheet" type="text/css">
        ...
        <tr style="font-family:calibri; color: #ffffff;">
          ...
          <td style=" margin:0; color: #ffffff;">
            <table style="width:100%; text-align:center;" border="0" cellspacing="0">
              ...
              <tr>
                <td style="width:50px; font-size: 8em; color: #333333;"><img src="http://avanzegroup.com/img/email/tick.png" width="25"/></td>
                <td style="text-align:left; color: #333333; font-size: 1.1em;">
                  <p style="font-weight: 500;">We have over 8 years of industry experience.</p>
                </td>
              </tr>
              ...
              <tr>
                <td style="width:80px;font-size: 2.5em; color: #333333;"><img src="http://avanzegroup.com/img/email/tick.png" width="25"/></td>
                <td style="text-align:left; color: #333333; font-size: 1.1em;">
                  <p style="font-weight: 500;">Hands-on experience in using major Title processing platforms.</p>
                </td>
              </tr>
              ...
              <tr><td height="10"></td></tr>
                ...
                <td style="width:80px;font-size: 2.5em; color: #333333;"><img src="http://avanzegroup.com/img/email/tick.png" width="25"/></td>
                <td style="text-align:left; color: #333333; font-size: 1.1em;">
                  <p style="font-weight: 500;">Millions of Title Search and Tax Certs delivered.</p>
                </td>
              </tr>
              ...
              <tr><td height="10"></td></tr>
                ...
                <td style="width:80px;font-size: 2.5em; color: #333333;"><img src="http://avanzegroup.com/img/email/tick.png" width="25"/></td>
                <td style="text-align:left; color: #333333; font-size: 1.1em;">
                  <p style="font-weight: 500;">Scalable delivery model with ability to ramp-up quickly.</p>
                </td>
              </tr>
                            ...
                            <tr>
                <td style="width:80px;font-size: 2.5em; color: #333333;" valign="top"><img src="http://avanzegroup.com/img/email/tick.png" width="25"/></td>

                <td style="text-align:left; color: #333333; font-size: 1.1em;">
                  <p style="font-weight: 500;">Hybrid Delivery Model - Multi centers mapped to process complexity and for load balancing.</p>
                </td>
              </tr>
              ...
              <tr><td height="10"></td></tr>
                        ...
                        <tbody>
                          ...
                          <td valign="middle">
                            <table align="center" border="0" cellspacing="0" cellpadding="0" width="100%">
                              <tbody>
                                <tr>
                                  <td height="10" width="100%" background="http://avanzegroup.com/img/email/pattern1.png" style="background-size: 100%; height: 10px;">&nbsp;</td>
                                </tr>
                              </tbody>
                            </table>
                          </td>
                ...
                <tr>
                  <td align="left" style="font-size: 1em; color: #333333; font-family: Roboto Condensed, Helvetica, arial, sans-serif; text-align: justify;">
                   At Avanze, we value your customers and members, and truly know how important it is to close each transaction timely with the highest levels of quality. Avanze is the right partner for you.
                  </td>
                </tr>
                ...
                <tr><td height="25"></td></tr>
                 ...
                 <tr>
                  <td align="left" style="font-size: 1em; color: #333333; font-family: Roboto Condensed, Helvetica, arial, sans-serif; text-align: justify;">
                To learn more, please email us at <b>advantage@avanzegroup.com</b> or call us at <br><b>302 319 4848</b>
                  </td>
                </tr>
                    ...
                    <table align="center" border="0" cellspacing="0" cellpadding="0" width="100%">
                      <tbody>
                        <tr>
                            ...
                            <td valign="top" align="center" width="33.3333333333%">
                               <a href="" target="_blank" style="color: #333333; text-decoration: none; font-size: 1em; font-family: Roboto Condensed, Helvetica, arial, sans-serif; text-align: center;">advantage@avanzegroup.com</a>
                            </td>
                            <td valign="top" align="center" width="33.3333333333%">
