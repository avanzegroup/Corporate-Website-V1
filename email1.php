...
if($_POST && isset($_FILES['my_file']))
{
    ...
    $from_email         = 'boopathiug@gmail.com'; //from mail, it is mandatory with some hosts
    $recipient_email    = 'boopathiug@gmail.com'; //recipient email (most cases it is your personal email)
